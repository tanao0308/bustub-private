...
LRUKReplacer::LRUKReplacer(size_t num_frames, size_t k) : replacer_size_(num_frames), k_(k) { node_store_.clear(); }
...
void LRUKReplacer::SetEvictable(frame_id_t frame_id, bool set_evictable) {
  ...
  num_evictable_ += static_cast<size_t>(node.is_evictable_) - static_cast<size_t>(set_evictable);
...
*/
auto LRUKReplacer::Size() -> size_t { return node_store_.size() - num_evictable_; }
